...
function makeRequestBody() {
    ...
    if (XPathResult.orderId) {
        //vider le panier
        deleteItem() {
            window.location.href = `/front/html/confirmation.html?confirmation=${result.order}`
        }
    }
    return body;
}
...
function submitForm(e) {
    ...
    function isNomInValid(ValidField) {
        ...
        if (regex.test(lastName.value) === false) {
            alert("Please enter a valid Nom");
            return false;
        }
        return ValidField;
    }
    ...
    function isCityInValid(ValidField) {
        ...
        if (regex.test(city.value) === false) {
            alert("Please enter a valid ville");
            return false;
        }
        return ValidField;
    }
